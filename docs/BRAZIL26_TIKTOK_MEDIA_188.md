...
4. Enable the new feature through a real Settings/environment or server runtime option, not the former dead `[collector].download_media` sample flag. The cron worker remains responsible for other media and transient errors.
