...
def test_ai26_public_template_is_synthetic_and_loadable():
...
def test_brazil26_public_template_is_synthetic_and_loadable():
...
def test_firefox_runtime_wrapper_keeps_capture_loopback_only():
